package by.it.group673602.padhaiski.lesson03;
...
public class Lesson3Test {
    ...
    */
    ...
    public void B() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        File f = new File(root + "by/it/group673602/prakhotsky/lesson03/encodeHuffman.txt");
    ...
    public void C() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        InputStream stream = new FileInputStream(root + "by/it/group673602/prakhotsky/lesson03/heapData.txt");

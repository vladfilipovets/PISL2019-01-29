package by.it.group673602.zakharevich.lesson03;
...
public class Lesson3Test {
    ...
    Поля:
    Name:               Test zakharevich (тут ваша фамилия)
    Test kind:          All in package
    Package:            by.it.group673602.zakharevich (тут ваша фамилия)
    ...
    */
    ...
    public void A() throws Exception {
        ...
        File f = new File(root + "by/it/group673602/zakharevich/lesson03/dataHuffman.txt");
